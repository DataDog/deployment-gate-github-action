...
To test if your changes work correctly, on a separate repository create a github action that uses the one from your branch. Check that your changes are working correctly and that the data appears as you expect in Datadog.

The changes will be tested from our side as well before merging.
